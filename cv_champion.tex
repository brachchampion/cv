...
\\[.5em]
``Association Between Urinary Incontinence and Memory Decline and Dementia Probability in a Longitudinal Cohort of Women'' (with Rachel High [lead author], Miriam Alvarez, Hitakshi Modi, Victoria Handa and Jennifer Anger) \textit{Submitted}
...
\section*{Teaching Experience}
  Instructor, \textit{U.S. Air Force Academy}
  ...
  \begin{itemize}[topsep=2pt,itemsep=-1pt,leftmargin=1em]
    \item[] Math Tools for Economists II, Intro to Statistics with Computer Applications
  \end{itemize}
  \vspace*{.5em}
